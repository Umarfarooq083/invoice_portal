...
<template>
    <GuestLayout>
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-dark-900 mb-2">Reset Password</h1>
            <p class="text-sm text-dark-500">Enter your new password below to reset your account password.</p>
        </div>
