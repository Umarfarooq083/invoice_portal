    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto py-6 px-4">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 class="text-xl font-bold text-slate-800">Edit Dealer</h1>
                    <p class="text-xs text-slate-400 mt-0.5">
                        Updating <span class="font-medium text-slate-600">{{ props.dealer.name }}</span>
                    </p>
                </div>
                <!-- Status Badge -->
                <span class="ml-auto px-3 py-1 text-xs font-medium rounded-full bg-blue-50 text-blue-600 border border-blue-100">
                    ID: {{ props.dealer.id }}
                </span>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/40 border border-slate-200/60 overflow-hidden">
                <div class="h-0.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500"></div>
