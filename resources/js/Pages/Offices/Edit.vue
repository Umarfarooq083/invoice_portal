        ...
        <div class="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Edit Office</h1>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="card overflow-hidden">
                    <div class="p-8 grid grid-cols-1 md:grid-cols-1 gap-6">
                        ...
                        <div>
                            <InputLabel for="address" value="Address" class="label" />
                            <TextInput id="address" type="text" class="mt-1" v-model="form.address" />
                            <InputError class="mt-1.5" :message="form.errors.address" />
                        </div>
                    </div>
                    
                    <div class="flex items-center justify-end gap-4 p-8 border-t border-slate-100 bg-slate-50/50">
                        <Link :href="route('offices.index')" class="btn-secondary">
                            Cancel
                        </Link>
                        <button type="submit" :disabled="form.processing" class="btn-primary min-w-[120px]">
                            ...
                            <span>{{ form.processing ? 'Updating...' : 'Update Office' }}</span>
                        </button>
                    </div>
                </div>
            </form>
