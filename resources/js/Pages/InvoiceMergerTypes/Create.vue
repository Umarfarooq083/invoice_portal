...
function submit() {
    form.post(route('invoice-merger-types.store'));
}
</script>

<template>
    <AuthenticatedLayout>
        <Head title="Create Invoice Merger Type" />
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 animate-fade-in">
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Create Invoice Merger Type</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 pb-12 pr-8">
                        ...
                        <button type="submit" :disabled="form.processing" class="btn-primary btn-lg min-w-[160px]">
                            ...
                            <span>{{ form.processing ? 'Saving...' : 'Create' }}</span>
                        </button>
                    </div>
                </div>
            </form>
