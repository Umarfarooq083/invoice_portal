...
import { useCreateApr } from '../composables/useCreateApr';
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 animate-fade-in">
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Create APR</h1>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8 animate-slide-up stagger-1">
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            <InputLabel for="sub_option_2" value="Select Head Type" class="label" />
                            <select id="sub_option_2" class="input mt-1" v-model="form.sub_option_2">
                                <option value="" disabled>Select option...</option>
                                <option v-for="option in HeadTypeOptions" :key="option.value" :value="option.value">
                                    {{ option.label }}
                                </option>
                            </select>
                ...
                <template v-if="form.society_id">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 pb-12 mr-7">
                            <Link :href="route('aprs.index')" class="btn-secondary btn-lg">
                                Cancel
                            </Link>
                            ...
                            <button type="submit" :disabled="form.processing" class="btn-primary btn-lg min-w-[160px]">
                                ...
                                <span>{{ form.processing ? 'Saving...' : 'Save APR' }}</span>
                            </button>
                        </div>
                    </div>
